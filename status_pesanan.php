...
<body role="document">
    ...
    <div class="container theme-showcase" role="main">
                    ...
                    <div class="col-md-6 menu-container <?php if ($i > $end_border) echo 'bottom'; ?>"
                        ...
                        <div class="media menu">
                            ...
                            <div class="media-body menu-desc">
                                ...
                                <?php $total_harga += $row["harga"] * $row['qty']; ?>
                                <div
        ...
        <?php if($pesanan['status'] == "Pelayanan") { ?>
        <form action="proses/selesai_pesanan.php" method="post">
            <hr>
            <input type="hidden" name="id_pesanan" value="<?php echo $pesanan['id_pesanana']; ?>">
            <input type="hidden" name="nomor_meja" value="<?php echo $pesanan['nomor_meja']; ?>">
            <input class="btn btn-success pull-right btn-submit" type="submit" value="Selesai Pesanan">
        </form>
        <?php } ?>
